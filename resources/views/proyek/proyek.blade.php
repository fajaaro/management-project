        ...
        <table class="table table-bordered table-striped table-hover mb-0" id="example2">
            ...
            @foreach ($proyek as $p)
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalEdit{{$p->id_project}}">Edit</h5>
                                </div>
                ...
                <tr>
                    ...
                    <td>
                        <center><a class="btn btn-sm btn-success" target="_blank" href="">{{ $p->status_project }}</a></center>
                    </td>
                    <td>
                        <a class="btn btn-xs btn-info modal-title" target="_blank" href="{{route('proyek.tim', ['id' => $p->id_project])}}">Tim</a>
                        <a class="btn btn-xs btn-info modal-title" id="exampleModalLabel"  data-bs-toggle="modal" data-bs-target="#show{{$p->id_project}}">Detail</a>
                        <a class="btn btn-xs btn-warning modal-title" id="modalEdit{{$p->id_project}}"  data-bs-toggle="modal" data-bs-target="#edit{{$p->id_project}}">Edit</a>
